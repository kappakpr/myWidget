...
ts.plot(temp,ylab="BRL Exchange")

#difference first order
xts = diff(temp, lag=1,differences = 1)
ts.plot(xts,ylab="BRL Exchange Differenced")
...
ts.plot(temp,ylab="BRL Exchange",main="Moving Average Trend")
...
ts.plot(temp,ylab="BRL Exchange",main="Parametric quadraric polynomial")
...
## Is there a trend? 
ts.plot(temp,ylab="BRL Exchange",main="Local Polynomial Trend Estimation")
lines(temp.fit.loc,lwd=2,col="brown")
#lines(temp.fit.gam,lwd=2,col="red")
abline(temp.fit.loc[1],0,lwd=2,col="blue")


ts.plot(temp,ylab="BRL Exchange",main="Splines Trend")
#lines(temp.fit.loc,lwd=2,col="brown")
lines(temp.fit.gam,lwd=2,col="red")
abline(temp.fit.loc[1],0,lwd=2,col="blue")
...
ts.plot(temp.fit.lm,lwd=2,col="green",ylim=ylim,ylab="BRL Exchange",main="Trend Plots Compare")
lines(temp.fit.mav,lwd=2,col="purple")
lines(temp.fit.gam,lwd=2,col="red")
lines(temp.fit.loc,lwd=2,col="brown")
...
plot(1:12,st1,lwd=2,type="l",xlab="Month",ylab="Seasonality",main="Seasonality Compare")
